  ...
  const getDefaultIntegrations = (): Integration[] => [
    {
      ...
      name: 'Twitter / X',
      category: 'social',
      description: language === 'fr' ? 'Publiez et programmez vos tweets' : 'Publish and schedule your tweets',
      icon: (
      ...
      connected: true,
      lastSync: language === 'fr' ? 'il y a 2 heures' : '2 hours ago',
    ...
    },
    {
      ...
      name: 'LinkedIn',
      category: 'social',
      description: language === 'fr' ? 'Partagez du contenu professionnel' : 'Share professional content',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      color: 'text-blue-600',
      connected: true,
      lastSync: language === 'fr' ? 'il y a 1 heure' : '1 hour ago',
    ...
    },
    {
      ...
      name: 'Facebook',
      category: 'social',
      description: language === 'fr' ? 'Gérez vos pages Facebook' : 'Manage your Facebook pages',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: language === 'fr' ? 'Synchronisez votre calendrier éditorial' : 'Sync your editorial calendar',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      name: 'Slack',
      category: 'productivity',
      description: language === 'fr' ? 'Recevez des notifications dans Slack' : 'Receive notifications in Slack',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      name: 'Trello',
      category: 'productivity',
      description: language === 'fr' ? 'Gérez vos tâches et projets' : 'Manage your tasks and projects',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      category: 'productivity',
      description: language === 'fr' ? 'Collaborez avec votre équipe' : 'Collaborate with your team',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      name: 'Bitly',
      category: 'analytics',
      description: language === 'fr' ? 'Raccourcissez et suivez vos liens' : 'Shorten and track your links',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
