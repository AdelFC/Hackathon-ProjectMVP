...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  const toneStyles: Record<ToastType, { container: string; icon: React.ReactNode }> = {
    success: {
  ...
  return (
    <div
      className={`flex items-center gap-2 px-3 py-2 rounded-lg border shadow-lg bg-white dark:bg-gray-900 transition-all ${tone.container}`}
    >
      {tone.icon}
